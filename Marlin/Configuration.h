...
#define STRING_CONFIG_H_AUTHOR "(damienmg, Ender-3 with SKR 1.3)" // Who made the changes.
...
// Eryone Magnetic bed loose magnetism at 130C. This make the max temperature be 115C
// which is basically the max temperature the Ender-3 bed can reach.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 1600, 1643 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT MIN_PROBE_X    // X point for Z homing when homing all axes (G28).
